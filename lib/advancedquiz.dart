...
//loading questions
    ...
    class advancedquizpage extends StatefulWidget {
      ...
      Future<String> _loadData() async {
        return await rootBundle.loadString('lib/assets/advanced.json');
      }
      
      
    _advancedquizpageState createState() => _advancedquizpageState(mydata);  
    }
    class _advancedquizpageState extends State<advancedquizpage>{
    Future loadData() async {
      String jsonString = await loadData();
      final jsonResponse = json.decode(jsonString);
      Advanced begin = new Advanced.fromJson(jsonResponse);
      
    }  
    var mydata;
    _advancedquizpageState(this.mydata);
