...
//loading questions
    ...
    class beginnerquizpage extends StatefulWidget {
      ...
      Future<String> _loadData() async {
        return await rootBundle.loadString('lib/assets/beginner.json');
      }
      
      
    _beginnerquizpageState createState() => _beginnerquizpageState(mydata);  
    }
    class _beginnerquizpageState extends State<beginnerquizpage>{
    Future loadData() async {
      String jsonString = await loadData();
      final jsonResponse = json.decode(jsonString);
      Beginner begin = new Beginner.fromJson(jsonResponse);
      
    }  
    var mydata;
    _beginnerquizpageState(this.mydata);
